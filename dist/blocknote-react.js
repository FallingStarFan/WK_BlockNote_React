...
import Z, { createContext as Be, useContext as Te, useEffect as V, useState as w, useCallback as f, useMemo as y, useRef as N, useSyncExternalStore as Se, useLayoutEffect as qt, forwardRef as $t, useImperativeHandle as Kt, useReducer as Xt } from "react";
...
function Wn() {
  ...
  const t = e.comments, n = p(), o = x(), r = fe({
    trailingBlock: !1,
    dictionary: {
      ...o,
      placeholders: {
...
const qn = (e) => {
  ...
  const o = D(n.onUpdate.bind(n)), r = An(o == null ? void 0 : o.pendingComment), { isMounted: l, ref: c, style: s, getFloatingProps: d } = U(
...
var bt = {
  ...
  style: void 0,
  attr: void 0
}, We = Z.createContext && /* @__PURE__ */ Z.createContext(bt), $n = ["attr", "size", "title"];
function Kn(e, t) {
  if (e == null) return {};
  var n = Xn(e, t), o, r;
...
function Ct(e) {
  return e && e.map((t, n) => /* @__PURE__ */ Z.createElement(t.tag, le({
    key: n
  }, t.attr), Ct(t.child)));
}
function k(e) {
  return (t) => /* @__PURE__ */ Z.createElement(eo, ie({
    attr: le({}, e.attr)
  }, t), Ct(e.child));
}
function eo(e) {
  var t = (n) => {
    ...
    return n.className && (d = n.className), e.className && (d = (d ? d + " " : "") + e.className), /* @__PURE__ */ Z.createElement("svg", ie({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, n.attr, o, c, {
    ...
    }), l && /* @__PURE__ */ Z.createElement("title", null, l), e.children);
  };
  return We !== void 0 ? /* @__PURE__ */ Z.createElement(We.Consumer, null, (n) => t(n)) : t(bt);
}
function to(e) {
...
`)}`
  ...
  }, [t.id, a]), M = Io(d, e.userId);
  if (!e.body)
    return null;
  let T;
  const I = a.auth.canAddReaction(e), A = a.auth.canDeleteComment(e), j = a.auth.canUpdateComment(e), F = n && (t.resolved ? a.auth.canUnresolveThread(t) : a.auth.canResolveThread(t));
  c || (T = /* @__PURE__ */ v(
  ...
  const n = p(), o = x(), r = C(), l = De(r, e.resolvedBy ? [e.resolvedBy] : []), c = e.comments.map((s, d) => /* @__PURE__ */ i(
    Po,
    {
      thread: e,
      comment: s,
...
const Do = (e) => {
  ...
  const t = p(), n = x(), { block: o } = e, r = C(), [l, c] = w(""), s = f(
    (u) => {
  ...
  var h;
  const t = p(), n = x(), { block: o, setLoading: r } = e, l = C(), [c, s] = w(!1);
  V(() => {
    c && setTimeout(() => {
      s(!1);
    }, 3e3);
  ...
  const t = p(), n = x(), o = C(), [r, l] = w(!1), c = e.tabs ?? [
    ...o.uploadFile !== void 0 ? [
      {
...
const Wo = () => {
  const e = p(), t = x(), n = C(), o = Qe("text", n), r = Qe("background", n), l = R(n), [c, s] = w(
  ...
  const t = p(), n = x(), { url: o, text: r, editLink: l, showTextField: c } = e, [s, d] = w(o), [a, u] = w(r);
  V(() => {
    d(o), u(r);
  }, [r, o]);
  const h = f(
...
const $o = () => {
  var H;
  const e = C(), t = p(), n = x(), o = qo(e), r = R(e), [l, c] = w(!1), [s, d] = w(e.getSelectedLinkUrl() || ""), [a, u] = w(e.getSelectedText());
  z(() => {
    u(e.getSelectedText() || ""), d(e.getSelectedLinkUrl() || "");
  }, e), V(() => {
    var B;
    const b = (M) => {
      (M.ctrlKey || M.metaKey) && M.key === "k" && (c(!0), M.preventDefault());
    };
    return (B = e.prosemirrorView) == null || B.dom.addEventListener("keydown", b), () => {
      var M;
      (M = e.prosemirrorView) == null || M.dom.removeEventListener("keydown", b);
    };
  ...
  const e = x(), t = p(), n = C(), [o, r] = w(), l = R(n), c = y(() => {
    if (l.length !== 1)
      return;
    const a = l[0];
    if (J(a, n))
  ...
  const e = x(), t = p(), n = C(), o = R(n), [r, l] = w(!1);
  V(() => {
    l(!1);
  }, [o]);
  ...
  const t = p(), n = x(), o = C(), r = R(o), [l, c] = w(o.getTextCursorPosition().block), s = y(() => (e.items || tr(n)).filter(
...
const kr = (e) => {
  ...
  const t = p(), n = x(), o = e.dragHandleMenu || Mr;
  return /* @__PURE__ */ v(
    t.Generic.Menu.Root,
    {
      onOpenChange: (r) => {
...
function Tr(e) {
  const t = p(), n = x(), { items: o, loadingState: r, selectedIndex: l, onItemClick: c, columns: s } = e, d = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ i(
...
function Lr(e) {
  const n = O().setContentEditableProps, o = C(), {
    getItems: r,
...
function _r(e) {
  const t = C(), {
    ...
    [t.suggestionMenus, n]
  ), g = D(m), { isMounted: H, ref: b, style: B, getFloatingProps: M } = U(
  ...
  return !H || !g || !(g != null && g.ignoreQueryLength) && l && (g.query.startsWith(" ") || g.query.length < l) ? null : /* @__PURE__ */ i("div", { ref: b, style: B, ...M(), children: /* @__PURE__ */ i(
    Lr,
    {
      query: g.query,
...
function Er(e) {
  const t = p(), n = x(), { items: o, loadingState: r, selectedIndex: l, onItemClick: c } = e, s = r === "loading-initial" || r === "loading" ? /* @__PURE__ */ i(
...
function Or(e) {
  const t = C(), {
    ...
    [t.suggestionMenus, n]
  ), m = D(h), { isMounted: g, ref: H, style: b, getFloatingProps: B } = U(
    ...
    2e3,
    {
      ...
      middleware: [
        ...
        ue(),
        Ee({
          apply({ availableHeight: M, elements: T }) {
  ...
  return !g || !m || !(m != null && m.ignoreQueryLength) && r && (m.query.startsWith(" ") || m.query.length < r) ? null : /* @__PURE__ */ i(
    "div",
    {
      ref: H,
      style: b,
...
const Fr = (e, t = 0.3) => {
  ...
  const t = p(), n = x(), r = C().tableHandles;
  return r ? /* @__PURE__ */ i(
    t.Generic.Menu.Item,
    {
      onClick: () => {
  ...
  const t = p(), n = x(), o = C(), r = o.tableHandles, l = y(() => !r || !e.block ? [] : e.orientation === "row" ? r.getCellsAtRowHandle(e.block, e.index) : r.getCellsAtColumnHandle(e.block, e.index), [e.block, e.index, e.orientation, r]), c = (d, a) => {
  ...
  const t = p(), [n, o] = w(!1), r = e.tableHandleMenu || Wr, l = y(() => {
...
const Qr = (e) => {
  ...
  var l, c;
  const t = p(), n = x(), o = C(), r = (c = (l = e.block.content.rows[e.rowIndex]) == null ? void 0 : l.cells) == null ? void 0 : c[e.colIndex];
  ...
  const r = {
    ...
    return a != null && a.draggingState ? {
      draggedCellOrientation: (P = a == null ? void 0 : a.draggingState) == null ? void 0 : P.draggedCellOrientation,
  ...
  if (!a)
    return null;
  const A = e.tableHandle || qr, j = e.extendButton || Ar, F = e.tableCellHandle || ni;
  return /* @__PURE__ */ v(S, { children: [
...
function di(e, t) {
  const {
    ...
    ...I
  } = e, [A, j] = w(), F = O(), q = ii(), E = (F == null ? void 0 : F.colorSchemePreference) || q, P = r || (E === "dark" ? "dark" : "light");
...
const ui = Z.forwardRef(({ className: e, renderEditor: t, editorColorScheme: n, children: o, ...r }, l) => /* @__PURE__ */ i(
  "div",
  {
...
)), Xi = Z.forwardRef(di), mi = (e) => {
  const t = li(), n = C(), o = y(() => ci(), []), r = f(
    (l) => {
      n.mount(l, o);
    },
    [n, o]
...
const Ti = (e) => {
  ...
  const [t, n] = w("none"), o = N(null), r = C(), l = D(
